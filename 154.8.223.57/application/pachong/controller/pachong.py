...
conn = pymysql.connect(host='localhost',user='sql154_8_223_57',passwd='Y8Er87cjek',db='sql154_8_223_57',port=3306,charset='utf8')
cursor=conn.cursor()
...
def get_temperature(url):
	...
	for info in conmid2:
		...
		for index, tr in enumerate(tr_list): # enumerate可以返回元素的位置及内容
			...
			cursor.execute('insert into Weather(city,weather,wind,max,min) values(%s,%s,%s,%s,%s)', (city_name, weather, wind, max, min))	
